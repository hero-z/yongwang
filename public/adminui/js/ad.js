...
$(function() {
    ...
    $("#get_province").after(sb.toString());

});

// 省值变化时 处理市
function doProvAndCity() {
    var city = $("#city");
    var county = $("#district");
    ...
    if ($("#get_city").length === 0) {
        city.append("<option id='get_city' value='-1'>请选择您所在城市</option>");
    }
    if ($("#get_district").length === 0) {
        county.append("<option id='get_district' value='-1'>请选择您所在区/县</option>");
    }
    var sb = new StringBuffer();
    $.each(cityJson,
        function(i, val) {
            if (val.item_code.substr(0, 2) == $("#provincea").val().substr(0, 2) && val.item_code.substr(2, 4) != '0000' && val.item_code.substr(4, 2) == '00') {
                sb.append("<option value='" + val.item_code + "'>" + val.item_name + "</option>");
            }
        });
    $("#get_city").after(sb.toString());
} // 市值变化时 处理区/县



// 市值变化时 处理区/
function doCityAndCounty() {
    ...
    $("#get_district").after(sb.toString());
