...
@section('content')
    ...
    <div class="main">
		...
		</span>{{$shopinfo['merchant_short_name']}}
        </p>
        <div class="type">
    ...
    <div class="keyboard">
        <ul>
            ...
            <li class="confirm" data-txt="确认" id="payLogButton"></li>
                        ...
                        if (data.status == 1) {
                            AlipayJSBridge.call("tradePay", {
                                ...
                                if (result.resultCode == "9000") {
                                    window.location.href = "{{url('api/pufa/PaySuccess?price=')}}" + $("#price").html();
                                }
                                // 用户中途取消
