            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="col-sm-3">
                        ...
                        <a href="{{route('addUprint')}}"  class="btn btn-sm btn-success" style="color:white;">添加设备</a>
                        @endpermission
                    </div>
                            ...
                            <table class="table table-striped">
                                ...
                                @foreach($list as $v)
                                    <tr>
                                        ...
                                        <td><span class="pie">{{$v->code}}</span></td>
                                        ...
                                        <th>
                                            ...
                                            <a href="{{url('/admin/ticket/editUprint?id='.$v->id)}}">
    ...
    <script type="text/javascript">
        function del(id) {
            ...
            layer.confirm('确定要删除吗?', {
                ...
                $.get("{{route('deleteUprint')}}", {_token: "{{csrf_token()}}", id: id},
                        function (data) {
                            if(data.success){
                                window.location.href = "{{Route('UprintIndex')}}";
                            }else{
