...
@section('content')
    <div class="widget am-cf">
        ...
        <form class="am-form tpl-form-line-form" action="{{route('updateMerchine')}}" method="post">
            ...
            <input class="am-form-field" placeholder="请输入设备密钥" value="{{$list->msign}}" type="text" name="msign">
