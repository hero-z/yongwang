        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <a href="{{url('/admin/UnionPay/BranchAdd?pid='.$_GET['pid'])}}">
                        <button class="btn btn-success " type="button"><span class="bold">添加分店</span></button>
                    </a>
                    @permission("addOldBranch")
                    <a href="{{url('admin/alipayopen/addOldBranchIndex?pid='.$_GET['pid'].'&type=unionpay')}}" class="btn btn-sm btn-primary">绑定分店</a>
                    @endpermission
                    <a href="{{route("unionRestoreIndex")}}"> <button type="button" class="btn btn-outline btn-default">还原商户</button></a>
