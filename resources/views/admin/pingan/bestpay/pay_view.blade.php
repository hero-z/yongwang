...
@section('content')
    ...
    <input type="hidden" id="sub_merchant_id" value="{{$store->sub_merchant_id}}">
    <input type="hidden" id="merchant_id" value="{{$merchant_id}}">
    <input type="hidden" id="body" value="{{$store->alias_name}}">

    <div class="weui-wepay-pay__ft">

        <p class="weui-wepay-pay__info" style="font-size: 18px;">{{$store->alias_name}}</p>
    ...
    <div class="weui-wepay-pay">
        ...
        <div class="weui-wepay-pay__bd">
            ...
            <div class="weui-wepay-pay__inner wo1">
                ...
                <!--<div class="weui-wepay-pay__inputs"><strong class="weui-wepay-pay__strong">￥</strong>
                    ...
                    <input type="number" class="weui-wepay-pay__input" id="total_fee" placeholder="请输入金额">
    ...
    <div class="keyboard">
        <ul>
            ...
            <li class="confirm" data-txt="确认" onclick="pay_post()"></li>
            {{--<li class="confirm" data-txt="确认" >--}}
                {{--<button onclick="pay_post()"  id="payLogButton"  style="width: 100%;height: 100%;background-color: transparent;border: none;outline: medium"></button>--}}
            {{--</li>--}}
            <li data-num="4"></li>
            <li data-num="5"></li>
            <li data-num="6"></li>
            ...
            if(ck&&$("#price").html()){
                ...
                $.post("{{route('BestPayPost')}}", {
                    ...
                    if (data.success){
                        ...
                        {{--f='https://openapi-liquidation.51fubei.com/bestpayPage?trade_no='+data.return_value.trade_no+'&body='+body+'&callback_url={{route("acceptStatu")}}';--}}
                                {{--alert(f);--}}
                                window.location.href='https://openapi-liquidation.51fubei.com/bestpayPage?trade_no='+data.return_value.trade_no+'&body='+body+'&callback_url={{route("acceptStatu")}}';
                    }else {
