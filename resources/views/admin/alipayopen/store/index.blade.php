            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <form action="{{route("storeSearch")}}" method="post">
                        ...
                        @permission("alipayShopRestore")
                        <a href="{{route("restoreIndex")}}"  class="btn btn-sm btn-primary" style="color:white;">还原</a>
                        @endpermission
                        @permission("addOldShop")
                        <a href="{{route("addOldShop")}}"  class="btn btn-sm btn-primary" style="color:white;">添加已开口碑店铺</a>
                        @endpermission
                                        ...
                                        <tr>
                                            ...
                                            @if($v->audit_status=='AUDIT_FAILED'||$v->apply_id=="")
                                                <th>
                                                    ...
                                                    @endpermission
                                                    <a href="{{url('admin/alipayopen/editshoplists?id='.$v->id)}}">
                                            ...
                                            @elseif($v->shop_id)
                                                <th>
                                                    ...
                                                    <a href="{{url("admin/alipayopen/salipayBranchIndex?pid=".$v->id)}}">
                                                        <button type="button" class="btn btn-info">分店管理</button>
                                                    </a>
                                                    <a href="{{url('admin/alipayopen/CashierIndex?store_id='.$v->store_id.'&store_name='.$v->main_shop_name.'&id='.$v->id)}}">
