...
@section('content')
    ...
    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
        <div class="widget am-cf">
            <form method='post' class="am-form tpl-form-line-form" action="{{route('newMobileOrderlists')}}">
                ...
                <div class="am-u-sm-6">
                    <a href="{{route('mobile')}}">
                        <button class="am-btn am-btn-default am-btn-sm" type="button">旧订单</button>
                    </a>
                </div>
                {{csrf_field()}}
            </form>
                ...
                <table width="100%" class="am-table am-table-compact  tpl-table-black " id="example-r">
                    ...
                    @if($datapage)
                        @foreach($datapage as $v)
                            <tr class="gradeX">
                                <td class="am-u-sm-3">{{$v->total_amount}}</td>
                                <td class="am-u-sm-2">
                                    @if($v->type==101)
                                        支付宝当面付
                                    @elseif($v->type==102)
                                ...
                                @endif
                                <td class="am-u-sm-3">{{$v->updated_at}}</td>
