...
class AopClient
{
    ...
    //网关
    public $gatewayUrl = "https://openapi-paycompany-liquidation.wechatpark.com/gateway";
    //返回数据格式
    public $format = "json";
    //api版本
...
//		$priKey = file_get_contents($this->rsaPrivateKeyFilePath);
    ...
    protected function sign1($data, $signType = "RSA")
    {
    ...
    public function execute($data)
    {
        ...
        $sysParams['acquirer_id'] = $this->AcquirerId;
        //获取业务参数
        $apiParams = $data;
