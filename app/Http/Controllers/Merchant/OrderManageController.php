...
class OrderManageController extends Controller
{
    ...
    public function orderls(Request $request){
        ...
        if($mid->type==0){
            return view('merchant.orderlsadmin', compact('datapage', 'paginator','exportdata','shoplists','shoplistmain','userlists','paylists','shop_branch','shop_cashier','pay_source','status','store_type','time','time_start','time_end','totalje','counts'));
        }else{
            return view('merchant.orderls', compact('datapage', 'paginator','exportdata','shoplists','shoplistmain','userlists','paylists','shop_branch','shop_cashier','pay_source','status','store_type','time','time_start','time_end','totalje','counts'));
        }
